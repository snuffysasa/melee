...
s32 func_8006F238(struct _HSD_GObj*);
// ? func_8006F368(?);
// ? func_8006F3DC(?);
// ? func_8006F484(?);
// ? func_8006F4C8(?);
...
void ftLink_OnItemCatch(HSD_GObj*, int);
// ? ftLink_OnItemThrow(?);
// ? func_800EB250(?);
// ? func_800EB3BC(?);
// ? func_800EB42C(?);
...
// ? func_8015C2A8(?);
// ? func_8015C2E0(?);
s32 func_8015C31C(void);
// ? func_8015C358(?);
s32 func_8015C3A0(void);
struct _HSD_GObj* func_8015C3E8(u32);
...
s32 func_8026B588();
s32 func_8026B594(struct _HSD_GObj*);
// ? func_8026B5E4(?);
// ? func_8026B634(?);
// ? func_8026B684(?);
// ? func_8026B6A8(?);
